...
from chatbot.order_service import Order, OrderService
from chatbot.policy_engine import OrderStatus, PolicyDecision, PolicyEngine
...
def policy_decisions():
    ...
    return {
        "allowed": PolicyDecision(
            allowed=True, reason="Order eligible for cancellation"
        ),
        "denied": PolicyDecision(
            allowed=False, reason="Order too old for cancellation"
        ),
